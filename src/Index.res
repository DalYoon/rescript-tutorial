...
// - 함수는 arrow
// - arrow의 우측에
//   마지막 라인에 위치한 값이 return으로 취급된다.

// #함수의 타입 추론
// - 사용하는 연산자나 변수가 활용되는 방식에 의해 타입 추론이 된다.

// #함수의 부분적 수행과 합성
// - 전달하지 않은 인자가, 암묵적인 undefined으로 처리되지 않고, 부분적으로만 수행된다.
...
// - 연산 체이닝 과정에서 option이라는 컨텍스트를 분리해서 다룰 수 있다.
